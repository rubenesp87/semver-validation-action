...
The http-client is built using the latest LTS version of Node 18. It may work on previous node LTS versions but it's tested and officially supported on Node18+.
